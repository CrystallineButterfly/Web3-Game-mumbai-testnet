...
export class RandomWinnerGame extends ethereum.SmartContract {
  ...
  gameId(): BigInt {
    const result = super.call('gameId', 'gameId():(uint256)', []);

    return result[0].toBigInt();
  }

  try_gameId(): ethereum.CallResult<BigInt> {
    const result = super.tryCall('gameId', 'gameId():(uint256)', []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  gameStarted(): boolean {
    const result = super.call('gameStarted', 'gameStarted():(bool)', []);

    return result[0].toBoolean();
  }

  try_gameStarted(): ethereum.CallResult<boolean> {
    const result = super.tryCall('gameStarted', 'gameStarted():(bool)', []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  keyHash(): Bytes {
    const result = super.call('keyHash', 'keyHash():(bytes32)', []);

    return result[0].toBytes();
  }

  try_keyHash(): ethereum.CallResult<Bytes> {
    const result = super.tryCall('keyHash', 'keyHash():(bytes32)', []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  players(param0: BigInt): Address {
    const result = super.call('players', 'players(uint256):(address)', [
  ...
  try_players(param0: BigInt): ethereum.CallResult<Address> {
    const result = super.tryCall('players', 'players(uint256):(address)', [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
